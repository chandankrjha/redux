...
class BaseDAO {
  ...
  private callNext() {
    ...
    $.ajax({
      ...
      beforeSend: function (request) {
        request.setRequestHeader("Authorization", "Bearer " + task.data.code);
      },
      data: $.param(task.data),//$.extend({}, {}, task.data),
      //dataType: 'json',
      xhrFields: {
  ...
  call(name: string, data: any, parameters?: any, urlInputs?: { [key: string]: string }): JQueryPromise<any> {
